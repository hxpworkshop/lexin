...
class MyFrame2(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"微信步数修改器", pos=wx.DefaultPosition, size=wx.Size(500, 332),
        ...
        self.m_staticText4 = wx.StaticText(self, wx.ID_ANY, u"请输入账号，密码和步数", wx.DefaultPosition, wx.DefaultSize, 0)
